...
def segs_to_counts(segmented_text):
    """ Compute number of tokens in a segment """
    return flatten([sent_counts(seg.split('|')) for seg in segmented_text])

def sent_counts(sents):
